$(document).ready(function () {
    ...
    // Page dynamic poster
    // Dynamic change poster function
    setInterval(dynamicPoster, 5000);
    // /Dynamic change poster function
    var left = 0;
    var top = 0;
...
// Dynamic change poster function
var i = 0;
function dynamicPoster() {
    if (i === 4) {
        i = 0;
    }
    var imagesUrl = ['ab2.jpg', 'ab3.jpg', 'ab4.jpg', 'abstruct.jpg'];
    var myHeader = document.getElementById('container-fluid');
    myHeader.style.transition = "all .5s linear";
    myHeader.style.backgroundImage = "url('../images/" + imagesUrl[i] +"')";
    i++;
}
// Dynamic change poster function
